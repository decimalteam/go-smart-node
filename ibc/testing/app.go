...
import (
	...
	dscapp "bitbucket.org/decimalteam/go-smart-node/app"
)

var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = dscapp.SetupTestingApp
