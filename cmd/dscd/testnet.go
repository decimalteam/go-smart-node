...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "dscd", "Home directory of the node's daemon configuration")
...
func initTestnetFiles(
	...
	if args.chainID == "" {
		args.chainID = "decimal-localnet-0"
	}
	...
	for i := 0; i < args.numValidators; i++ {
		...
		kb, err := keyring.New(sdk.KeyringServiceName(), args.keyringBackend, nodeDir, inBuf, dsckr.Option())
		if err != nil {
			return err
		}
