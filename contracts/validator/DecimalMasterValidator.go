...
// ValidatorRewardPerBlockUpdated represents a RewardPerBlockUpdated event raised by the Validator contract.
type ValidatorRewardPerBlockUpdated struct {
