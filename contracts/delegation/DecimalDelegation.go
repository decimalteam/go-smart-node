...
// IDecimalDelegationAutoUnbondEntry is an auto generated low-level Go binding around an user-defined struct.
type IDecimalDelegationAutoUnbondEntry struct {
...
// AutoUnbondQueueLength is a free data retrieval call binding the contract method 0x7cef101a.
//
// Solidity: function autoUnbondQueueLength() view returns(uint256)
func (_Delegation *DelegationCaller) AutoUnbondQueueLength(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Delegation.contract.Call(opts, &out, "autoUnbondQueueLength")
...
//
// Solidity: function autoUnbondQueueLength() view returns(uint256)
func (_Delegation *DelegationSession) AutoUnbondQueueLength() (*big.Int, error) {
	return _Delegation.Contract.AutoUnbondQueueLength(&_Delegation.CallOpts)
}

// AutoUnbondQueueLength is a free data retrieval call binding the contract method 0x7cef101a.
//
// Solidity: function autoUnbondQueueLength() view returns(uint256)
func (_Delegation *DelegationCallerSession) AutoUnbondQueueLength() (*big.Int, error) {
	return _Delegation.Contract.AutoUnbondQueueLength(&_Delegation.CallOpts)
}

// GetAutoUnbondEntry is a free data retrieval call binding the contract method 0xfc94ffba.
//
// Solidity: function getAutoUnbondEntry(uint256 index) view returns((address,address,uint256,address,uint256))
func (_Delegation *DelegationCaller) GetAutoUnbondEntry(opts *bind.CallOpts, index *big.Int) (IDecimalDelegationAutoUnbondEntry, error) {
	var out []interface{}
	err := _Delegation.contract.Call(opts, &out, "getAutoUnbondEntry", index)

	if err != nil {
		return *new(IDecimalDelegationAutoUnbondEntry), err
	}

	out0 := *abi.ConvertType(out[0], new(IDecimalDelegationAutoUnbondEntry)).(*IDecimalDelegationAutoUnbondEntry)
...
//
// Solidity: function getAutoUnbondEntry(uint256 index) view returns((address,address,uint256,address,uint256))
func (_Delegation *DelegationSession) GetAutoUnbondEntry(index *big.Int) (IDecimalDelegationAutoUnbondEntry, error) {
...
//
// Solidity: function getAutoUnbondEntry(uint256 index) view returns((address,address,uint256,address,uint256))
func (_Delegation *DelegationCallerSession) GetAutoUnbondEntry(index *big.Int) (IDecimalDelegationAutoUnbondEntry, error) {
	return _Delegation.Contract.GetAutoUnbondEntry(&_Delegation.CallOpts, index)
}
...
// AutoUnbondEnqueue is a paid mutator transaction binding the contract method 0xa1d76351.
//
// Solidity: function autoUnbondEnqueue(address validator, address delegator, uint256 amount, address token) returns()
func (_Delegation *DelegationTransactor) AutoUnbondEnqueue(opts *bind.TransactOpts, validator common.Address, delegator common.Address, amount *big.Int, token common.Address) (*types.Transaction, error) {
	return _Delegation.contract.Transact(opts, "autoUnbondEnqueue", validator, delegator, amount, token)
}

// AutoUnbondEnqueue is a paid mutator transaction binding the contract method 0xa1d76351.
//
// Solidity: function autoUnbondEnqueue(address validator, address delegator, uint256 amount, address token) returns()
func (_Delegation *DelegationSession) AutoUnbondEnqueue(validator common.Address, delegator common.Address, amount *big.Int, token common.Address) (*types.Transaction, error) {
	return _Delegation.Contract.AutoUnbondEnqueue(&_Delegation.TransactOpts, validator, delegator, amount, token)
}

// AutoUnbondEnqueue is a paid mutator transaction binding the contract method 0xa1d76351.
//
// Solidity: function autoUnbondEnqueue(address validator, address delegator, uint256 amount, address token) returns()
func (_Delegation *DelegationTransactorSession) AutoUnbondEnqueue(validator common.Address, delegator common.Address, amount *big.Int, token common.Address) (*types.Transaction, error) {
	return _Delegation.Contract.AutoUnbondEnqueue(&_Delegation.TransactOpts, validator, delegator, amount, token)
}
...
// MigrateStakes is a paid mutator transaction binding the contract method 0xa5a6977e.
//
// Solidity: function migrateStakes(address[] validators, address[] oldDelegators, address[] newDelegators, address[] tokens) returns()
func (_Delegation *DelegationTransactor) MigrateStakes(opts *bind.TransactOpts, validators []common.Address, oldDelegators []common.Address, newDelegators []common.Address, tokens []common.Address) (*types.Transaction, error) {
	return _Delegation.contract.Transact(opts, "migrateStakes", validators, oldDelegators, newDelegators, tokens)
}

// MigrateStakes is a paid mutator transaction binding the contract method 0xa5a6977e.
//
// Solidity: function migrateStakes(address[] validators, address[] oldDelegators, address[] newDelegators, address[] tokens) returns()
func (_Delegation *DelegationSession) MigrateStakes(validators []common.Address, oldDelegators []common.Address, newDelegators []common.Address, tokens []common.Address) (*types.Transaction, error) {
...
// ProcessAutoUnbond is a paid mutator transaction binding the contract method 0xe54c8f7e.
//
// Solidity: function processAutoUnbond(uint256 index) returns()
func (_Delegation *DelegationTransactor) ProcessAutoUnbond(opts *bind.TransactOpts, index *big.Int) (*types.Transaction, error) {
	return _Delegation.contract.Transact(opts, "processAutoUnbond", index)
}

// ProcessAutoUnbond is a paid mutator transaction binding the contract method 0xe54c8f7e.
//
// Solidity: function processAutoUnbond(uint256 index) returns()
func (_Delegation *DelegationSession) ProcessAutoUnbond(index *big.Int) (*types.Transaction, error) {
	return _Delegation.Contract.ProcessAutoUnbond(&_Delegation.TransactOpts, index)
}

// ProcessAutoUnbond is a paid mutator transaction binding the contract method 0xe54c8f7e.
//
// Solidity: function processAutoUnbond(uint256 index) returns()
func (_Delegation *DelegationTransactorSession) ProcessAutoUnbond(index *big.Int) (*types.Transaction, error) {
	return _Delegation.Contract.ProcessAutoUnbond(&_Delegation.TransactOpts, index)
}
