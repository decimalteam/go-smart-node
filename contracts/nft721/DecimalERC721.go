...
func (_Nft721 *Nft721Caller) ContractURI(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Nft721.contract.Call(opts, &out, "contractURI")
...
//
// Solidity: function contractURI() view returns(string)
func (_Nft721 *Nft721Session) ContractURI() (string, error) {
	return _Nft721.Contract.ContractURI(&_Nft721.CallOpts)
}

// ContractURI is a free data retrieval call binding the contract method 0xe8a3d485.
//
// Solidity: function contractURI() view returns(string)
func (_Nft721 *Nft721CallerSession) ContractURI() (string, error) {
	return _Nft721.Contract.ContractURI(&_Nft721.CallOpts)
}
...
func (_Nft721 *Nft721Caller) Creator(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Nft721.contract.Call(opts, &out, "creator")
...
//
// Solidity: function creator() view returns(address)
func (_Nft721 *Nft721Session) Creator() (common.Address, error) {
	return _Nft721.Contract.Creator(&_Nft721.CallOpts)
}

// Creator is a free data retrieval call binding the contract method 0x02d05d3f.
//
// Solidity: function creator() view returns(address)
func (_Nft721 *Nft721CallerSession) Creator() (common.Address, error) {
	return _Nft721.Contract.Creator(&_Nft721.CallOpts)
}
...
func (_Nft721 *Nft721Transactor) Initialize(opts *bind.TransactOpts, initialSymbol string, initialName string, initialContractURI string, initialCreator common.Address, initialRefundable bool) (*types.Transaction, error) {
	return _Nft721.contract.Transact(opts, "initialize", initialSymbol, initialName, initialContractURI, initialCreator, initialRefundable)
}

// Initialize is a paid mutator transaction binding the contract method 0x28f7ed23.
//
// Solidity: function initialize(string initialSymbol, string initialName, string initialContractURI, address initialCreator, bool initialRefundable) returns()
func (_Nft721 *Nft721Session) Initialize(initialSymbol string, initialName string, initialContractURI string, initialCreator common.Address, initialRefundable bool) (*types.Transaction, error) {
	return _Nft721.Contract.Initialize(&_Nft721.TransactOpts, initialSymbol, initialName, initialContractURI, initialCreator, initialRefundable)
}

// Initialize is a paid mutator transaction binding the contract method 0x28f7ed23.
//
// Solidity: function initialize(string initialSymbol, string initialName, string initialContractURI, address initialCreator, bool initialRefundable) returns()
func (_Nft721 *Nft721TransactorSession) Initialize(initialSymbol string, initialName string, initialContractURI string, initialCreator common.Address, initialRefundable bool) (*types.Transaction, error) {
	return _Nft721.Contract.Initialize(&_Nft721.TransactOpts, initialSymbol, initialName, initialContractURI, initialCreator, initialRefundable)
}
...
func (_Nft721 *Nft721Transactor) Penalty(opts *bind.TransactOpts, tokenId *big.Int, percentage uint16) (*types.Transaction, error) {
...
//
// Solidity: function penalty(uint256 tokenId, uint16 percentage) returns()
func (_Nft721 *Nft721Session) Penalty(tokenId *big.Int, percentage uint16) (*types.Transaction, error) {
...
//
// Solidity: function penalty(uint256 tokenId, uint16 percentage) returns()
func (_Nft721 *Nft721TransactorSession) Penalty(tokenId *big.Int, percentage uint16) (*types.Transaction, error) {
	return _Nft721.Contract.Penalty(&_Nft721.TransactOpts, tokenId, percentage)
}
...
// Nft721ContractURIUpdatedIterator is returned from FilterContractURIUpdated and is used to iterate over the raw logs and unpacked data for ContractURIUpdated events raised by the Nft721 contract.
type Nft721ContractURIUpdatedIterator struct {
	Event *Nft721ContractURIUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Nft721ContractURIUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Nft721ContractURIUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Nft721ContractURIUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Nft721ContractURIUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Nft721ContractURIUpdated represents a ContractURIUpdated event raised by the Nft721 contract.
type Nft721ContractURIUpdated struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_Nft721 *Nft721Filterer) FilterContractURIUpdated(opts *bind.FilterOpts) (*Nft721ContractURIUpdatedIterator, error) {

	logs, sub, err := _Nft721.contract.FilterLogs(opts, "ContractURIUpdated")
	if err != nil {
		return nil, err
	}
	return &Nft721ContractURIUpdatedIterator{contract: _Nft721.contract, event: "ContractURIUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ContractURIUpdated()
func (_Nft721 *Nft721Filterer) WatchContractURIUpdated(opts *bind.WatchOpts, sink chan<- *Nft721ContractURIUpdated) (event.Subscription, error) {

	logs, sub, err := _Nft721.contract.WatchLogs(opts, "ContractURIUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Nft721ContractURIUpdated)
				if err := _Nft721.contract.UnpackLog(event, "ContractURIUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ContractURIUpdated()
func (_Nft721 *Nft721Filterer) ParseContractURIUpdated(log types.Log) (*Nft721ContractURIUpdated, error) {
	event := new(Nft721ContractURIUpdated)
	if err := _Nft721.contract.UnpackLog(event, "ContractURIUpdated", log); err != nil {
		return nil, err
	}
