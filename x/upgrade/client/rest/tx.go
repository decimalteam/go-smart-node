...
type PlanRequest struct {
	...
	UpgradeToDownload int64        `json:"upgrade_to_download" yaml:"upgrade_to_download"`
}
...
func newPostPlanHandler(clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		plan := types.Plan{Name: req.UpgradeName, Height: req.UpgradeHeight, Info: req.UpgradeInfo, ToDownload: req.UpgradeToDownload}
