...
import (
	...
	xp "bitbucket.org/decimalteam/go-smart-node/x/upgrade/exported"
...
// UrlPageExist Check if page exists.
...
// GetDownloadName Generate name of download file.
...
func (k Keeper) ChangeBinary(plan types.Plan) error {
	...
	if !fileHashEqual(downloadName, hashes[0]) {
