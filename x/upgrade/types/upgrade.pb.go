...
// source: decimal/upgrade/v1/upgrade.proto
...
type Plan struct {
	...
	Time time.Time `protobuf:"bytes,2,opt,name=time,proto3,stdtime" json:"time" yaml:"time"` // Deprecated: Do not use.
	// The height at which the upgrade must be performed.
	// Only used if Time is not set.
	Height int64 `protobuf:"varint,3,opt,name=height,proto3" json:"height" yaml:"height"`
	// Any application specific upgrade info to be included on-chain
	// such as a git commit that validators could automatically upgrade to
	Info string `protobuf:"bytes,4,opt,name=info,proto3" json:"info" yaml:"info"`
	// the height of the block where the download of the binary file will start
	ToDownload int64 `protobuf:"varint,5,opt,name=to_download,json=toDownload,proto3" json:"to_download" yaml:"to_download"`
	// Deprecated: UpgradedClientState field has been deprecated. IBC upgrade logic has been
	// moved to the IBC module in the sub module 02-client.
	// If this field is not empty, an error will be thrown.
	UpgradedClientState *types.Any `protobuf:"bytes,6,opt,name=upgraded_client_state,json=upgradedClientState,proto3" json:"upgraded_client_state,omitempty" yaml:"upgraded_client_state"` // Deprecated: Do not use.
}

func (m *Plan) Reset()      { *m = Plan{} }
func (*Plan) ProtoMessage() {}
func (*Plan) Descriptor() ([]byte, []int) {
	return fileDescriptor_12b7155b35dc8893, []int{0}
}
...
func (*SoftwareUpgradeProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_12b7155b35dc8893, []int{1}
}
...
func (*CancelSoftwareUpgradeProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_12b7155b35dc8893, []int{2}
}
...
func (*ModuleVersion) Descriptor() ([]byte, []int) {
	return fileDescriptor_12b7155b35dc8893, []int{3}
}
...
func init() {
	proto.RegisterType((*Plan)(nil), "decimal.upgrade.v1.Plan")
	proto.RegisterType((*SoftwareUpgradeProposal)(nil), "decimal.upgrade.v1.SoftwareUpgradeProposal")
	proto.RegisterType((*CancelSoftwareUpgradeProposal)(nil), "decimal.upgrade.v1.CancelSoftwareUpgradeProposal")
	proto.RegisterType((*ModuleVersion)(nil), "decimal.upgrade.v1.ModuleVersion")
}

func init() { proto.RegisterFile("decimal/upgrade/v1/upgrade.proto", fileDescriptor_12b7155b35dc8893) }

var fileDescriptor_12b7155b35dc8893 = []byte{
	// 550 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Plan) Equal(that interface{}) bool {
	...
	if this.ToDownload != that1.ToDownload {
		return false
	}
...
func (m *Plan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ToDownload != 0 {
		i = encodeVarintUpgrade(dAtA, i, uint64(m.ToDownload))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Info) > 0 {
...
func (m *Plan) Size() (n int) {
	...
	if m.ToDownload != 0 {
		n += 1 + sovUpgrade(uint64(m.ToDownload))
	}
	if m.UpgradedClientState != nil {
