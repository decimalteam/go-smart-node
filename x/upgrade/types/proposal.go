...
const (
	ProposalTypeSoftwareUpgrade       string = "DSCSoftwareUpgrade"
	ProposalTypeCancelSoftwareUpgrade string = "DSCCancelSoftwareUpgrade"
)
...
func init() {
	...
	gov.RegisterProposalTypeCodec(&SoftwareUpgradeProposal{}, "decimal/SoftwareUpgradeProposal")
	gov.RegisterProposalType(ProposalTypeCancelSoftwareUpgrade)
	gov.RegisterProposalTypeCodec(&CancelSoftwareUpgradeProposal{}, "decimal/CancelSoftwareUpgradeProposal")
}
