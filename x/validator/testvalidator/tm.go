...
func ToTmValidator(v types.Validator, r sdkmath.Int) (*tmtypes.Validator, error) {
...
func ToTmValidators(v types.Validators, r sdkmath.Int) ([]*tmtypes.Validator, error) {
