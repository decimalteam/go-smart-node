...
type Stake struct {
	...
	Holds []*StakeHold `protobuf:"bytes,5,rep,name=holds,proto3" json:"holds,omitempty"`
}
...
// HaltInfo stores the state of an admin-scheduled hard consensus halt.
// When active, the validator BeginBlocker panics at and after the given
// height, stopping block production until the halt is cleared.
type HaltInfo struct {
	// active reports whether a hard halt is currently scheduled.
	Active bool `protobuf:"varint,1,opt,name=active,proto3" json:"active,omitempty"`
	// height is the block height at and after which the chain halts.
	Height int64 `protobuf:"varint,2,opt,name=height,proto3" json:"height,omitempty"`
	// reason is a free-form human-readable explanation for the halt.
	Reason string `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`
	// sender is the bech32-encoded address of the admin that scheduled the halt.
	Sender string `protobuf:"bytes,4,opt,name=sender,proto3" json:"sender,omitempty"`
}

func (m *HaltInfo) Reset()         { *m = HaltInfo{} }
func (m *HaltInfo) String() string { return proto.CompactTextString(m) }
func (*HaltInfo) ProtoMessage()    {}
func (*HaltInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae746e987c590f4, []int{14}
}
func (m *HaltInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HaltInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HaltInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HaltInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HaltInfo.Merge(m, src)
}
func (m *HaltInfo) XXX_Size() int {
	return m.Size()
}
func (m *HaltInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_HaltInfo.DiscardUnknown(m)
}

var xxx_messageInfo_HaltInfo proto.InternalMessageInfo

func (m *HaltInfo) GetActive() bool {
	if m != nil {
		return m.Active
	}
	return false
...
func (m *HaltInfo) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *HaltInfo) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
func (m *HaltInfo) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
// FreezeInfo stores the state of an admin-triggered soft transaction freeze.
// When frozen, the ante handler rejects all transactions except emergency
// admin messages, while the chain keeps producing empty blocks.
type FreezeInfo struct {
	// frozen reports whether the chain is currently soft-frozen.
	...
	// sender is the bech32-encoded address of the admin that froze the chain.
...
func (*FreezeInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ae746e987c590f4, []int{15}
}
...
func (m *FreezeInfo) GetSender() string {
	if m != nil {
		return m.Sender
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*HaltInfo)(nil), "decimal.validator.v1.HaltInfo")
	proto.RegisterType((*FreezeInfo)(nil), "decimal.validator.v1.FreezeInfo")
}
...
var fileDescriptor_3ae746e987c590f4 = []byte{
	...
	,
}
...
func (m *HaltInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HaltInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HaltInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Sender) > 0 {
		...
		i = encodeVarintValidator(dAtA, i, uint64(len(m.Sender)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Reason) > 0 {
		...
		i = encodeVarintValidator(dAtA, i, uint64(len(m.Reason)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Height != 0 {
...
func (m *HaltInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HaltInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HaltInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
