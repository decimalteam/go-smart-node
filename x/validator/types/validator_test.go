...
//	expectedVals, err := testvalidator.ToTmValidators(valz, sdk.DefaultPowerReduction)
//	require.NoError(t, err)
...
//	})
//	actualVals, err := testvalidator.ToTmValidators(valz, sdk.DefaultPowerReduction)
//	require.NoError(t, err)
//
...
//	}
//	vs, err := testvalidator.ToTmValidators(vals, sdk.DefaultPowerReduction)
//	require.NoError(t, err)
