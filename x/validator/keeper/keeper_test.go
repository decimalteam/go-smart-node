...
// 	querier := keeper.Querier{Keeper: app.ValidatorKeeper}

// 	queryHelper := baseapp.NewQueryServerTestHelper(ctx, app.InterfaceRegistry())
// 	types.RegisterQueryServer(queryHelper, querier)
// 	queryClient := types.NewQueryClient(queryHelper)

// 	suite.msgServer = keeper.NewMsgServerImpl(app.ValidatorKeeper)
...
// 	app.ValidatorKeeper.SetHistoricalInfo(ctx, 5, &hi)
...
// 	resParams := app.ValidatorKeeper.GetParams(ctx)
// 	require.True(t, expParams.Equal(resParams))

// 	// modify a params, save, and retrieve
// 	expParams.MaxValidators = 777
// 	app.ValidatorKeeper.SetParams(ctx, expParams)
