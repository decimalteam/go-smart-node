...
var (
	...
	UBDAlreadyProcessed             = errors.New(codespace, 131, "undelegation is already processed")
	WrongStakeID                    = errors.New(codespace, 132, "wrong stake id")
	REDNotFound                     = errors.New(codespace, 133, "redelegation not found for pair (validatorSrc, validatorDst, delegator)")
	REDEntryNotFound                = errors.New(codespace, 134, "redelegation entry not found for height")
	REDAlreadyProcessed             = errors.New(codespace, 135, "redelegation is already processed")
	CoinDoesNotExist                = errors.New(codespace, 136, "coin does not exist")
)
