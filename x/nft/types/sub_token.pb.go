...
type SubToken struct {
	...
	Reserve string `protobuf:"bytes,2,opt,name=reserve,proto3" json:"reserve" yaml:"reserve"`
}
...
func (m *SubToken) GetReserve() string {
	if m != nil {
		return m.Reserve
	}
	return ""
...
var fileDescriptor_575007536cbf0636 = []byte{
	...
	,
}
...
func (m *SubToken) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Reserve) > 0 {
		...
		i = encodeVarintSubToken(dAtA, i, uint64(len(m.Reserve)))
		i--
		dAtA[i] = 0x12
	}
	if m.ID != 0 {
