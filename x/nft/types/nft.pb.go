...
const (
	...
	NftType_Unspecified NftType = 0
	// COIN defines the type for stakes in coin.
	NftType_NFT721 NftType = 1
	// NFT defines the type for stakes in NFT.
	NftType_NFT1155 NftType = 2
)
...
type Collection struct {
	...
	TypeNft NftType `protobuf:"varint,5,opt,name=typeNft,proto3,enum=decimal.nft.v1.NftType" json:"typeNft,omitempty"`
	// address nft defines the NFT collection name.
	AddressDRC string `protobuf:"bytes,6,opt,name=addressDRC,proto3" json:"addressDRC,omitempty"`
}
...
func init() {
	proto.RegisterEnum("decimal.nft.v1.NftType", NftType_name, NftType_value)
...
var fileDescriptor_48e340f93e0c6acc = []byte{
	...
	,
}
...
func (this *Collection) Equal(that interface{}) bool {
	...
	if this.TypeNft != that1.TypeNft {
		return false
	}
	if this.AddressDRC != that1.AddressDRC {
		return false
	}
	return true
}
...
func (m *Collection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AddressDRC) > 0 {
		i -= len(m.AddressDRC)
		copy(dAtA[i:], m.AddressDRC)
		i = encodeVarintNft(dAtA, i, uint64(len(m.AddressDRC)))
		i--
		dAtA[i] = 0x32
	}
	if m.TypeNft != 0 {
		i = encodeVarintNft(dAtA, i, uint64(m.TypeNft))
		i--
		dAtA[i] = 0x28
	}
	if len(m.Tokens) > 0 {
...
func (m *Collection) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TypeNft", wireType)
			}
			m.TypeNft = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TypeNft |= NftType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddressDRC", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddressDRC = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
