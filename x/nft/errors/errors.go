...
var (
	...
	NotAllowedBurn                = errors.New(codespace, 108, "only the creator can burn token")
	NotAllowedMint                = errors.New(codespace, 109, "only the creator can mint a token")
	...
	NotAllowedUpdateReserve       = errors.New(codespace, 119, "only the creator can update reserve a token")
	...
	NftSupply             = errors.New(codespace, 125, "NFTs count not equal to total nft supply")
	InvalidSubTokensLen   = errors.New(codespace, 126, "invalid sub tokens len for nft")
	UnknownSubTokenForNFT = errors.New(codespace, 127, "unknown sub token id for nft")
)
