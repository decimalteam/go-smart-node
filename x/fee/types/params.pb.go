...
type Params struct {
	...
	CommissionBurnFactor github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,70,opt,name=commission_burn_factor,json=commissionBurnFactor,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"commission_burn_factor"`
	// evm tx commissions
	EvmGasPrice github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,61,opt,name=evm_gas_price,json=evmGasPrice,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"evm_gas_price"`
	// oracle defines address empowered to update coin prices.
	Oracle string `protobuf:"bytes,62,opt,name=oracle,proto3" json:"oracle,omitempty"`
}
...
var fileDescriptor_4d019b262529661a = []byte{
	...
	,
}
