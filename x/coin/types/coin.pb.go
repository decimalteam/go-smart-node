...
type CoinDRC struct {
	...
	Denom string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	// drc20_address is the hex address of ERC20 contract token
	DRC20Contract string `protobuf:"bytes,2,opt,name=drc20_address,json=drc20Address,proto3" json:"drc20_address,omitempty"`
}

func (m *CoinDRC) Reset()         { *m = CoinDRC{} }
func (m *CoinDRC) String() string { return proto.CompactTextString(m) }
func (*CoinDRC) ProtoMessage()    {}
func (*CoinDRC) Descriptor() ([]byte, []int) {
	return fileDescriptor_b0da51b7c52dac0b, []int{3}
}
func (m *CoinDRC) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CoinDRC) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CoinDRC.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CoinDRC) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CoinDRC.Merge(m, src)
}
func (m *CoinDRC) XXX_Size() int {
	return m.Size()
}
func (m *CoinDRC) XXX_DiscardUnknown() {
	xxx_messageInfo_CoinDRC.DiscardUnknown(m)
}

var xxx_messageInfo_CoinDRC proto.InternalMessageInfo

// CoinDRC defines object containing just DRC contract address of the coin.
type CoinCenterAddr struct {
	// drc20_address is the hex address of ERC20 contract token
	DRC20Contract string `protobuf:"bytes,2,opt,name=drc20_address,json=drc20Address,proto3" json:"drc20_address,omitempty"`
}

func (m *CoinCenterAddr) Reset()         { *m = CoinCenterAddr{} }
func (m *CoinCenterAddr) String() string { return proto.CompactTextString(m) }
func (*CoinCenterAddr) ProtoMessage()    {}
func (*CoinCenterAddr) Descriptor() ([]byte, []int) {
	return fileDescriptor_b0da51b7c52dac0b, []int{4}
}
func (m *CoinCenterAddr) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CoinCenterAddr) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CoinCenterAddr.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CoinCenterAddr) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CoinCenterAddr.Merge(m, src)
}
func (m *CoinCenterAddr) XXX_Size() int {
	return m.Size()
}
func (m *CoinCenterAddr) XXX_DiscardUnknown() {
	xxx_messageInfo_CoinCenterAddr.DiscardUnknown(m)
}

var xxx_messageInfo_CoinCenterAddr proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*CoinDRC)(nil), "decimal.coin.v1.CoinDRC")
	proto.RegisterType((*CoinCenterAddr)(nil), "decimal.coin.v1.CoinCenterAddr")
}
...
var fileDescriptor_b0da51b7c52dac0b = []byte{
	...
	,
}
...
func (this *CoinDRC) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CoinDRC)
	if !ok {
		that2, ok := that.(CoinDRC)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CoinCenterAddr) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CoinCenterAddr)
	if !ok {
		that2, ok := that.(CoinCenterAddr)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *CoinDRC) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CoinDRC) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CoinDRC) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CoinCenterAddr) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CoinCenterAddr) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CoinCenterAddr) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CoinCenterAddr) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CoinDRC) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CoinDRC: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CoinDRC: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CoinCenterAddr) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CoinCenterAddr: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CoinCenterAddr: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
