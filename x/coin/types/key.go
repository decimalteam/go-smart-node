...
var (
	...
	keyPrefixCoinDRC = []byte{0x13} // prefix for each key to a record containing coin DRC address contract
...
func GetCoinDRCKey(addressDRC string) []byte {
	return append(keyPrefixCoinDRC, []byte(addressDRC)...)
}
